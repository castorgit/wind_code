...
def plot_something():
    ...
    data = []
    for i in range(2, 6):
        nc_fid = Dataset("/home/HPAI-BSC/storage/Data/Wind/files/0/%d.nc" % i, 'r')
...
if __name__ == '__main__':
    nc_fid = Dataset("/home/HPAI-BSC/storage/Data/Wind/files/90/45142.nc", 'r')
    print(ncdump(nc_fid))
    ...
    # itime = time.time()
    # nc_fid = Dataset("/home/HPAI-BSC/storage/Data/Wind/files/0/0.nc", 'r')
    ...
    # mdata = {}
    # for wf in wfiles:
    #     print "/home/HPAI-BSC/storage/Data/Wind/files/%s.nc" % wf
    #     nc_fid = Dataset("/home/HPAI-BSC/storage/Data/Wind/files/%s.nc" % wf, 'r')
    #     ldata = []
    #     for v in vars:
    ...
    #     # np.save('/home/HPAI-BSC/wind%s.npy' % (wf.replace('/', '-')), data30)
    # print(mdata)
    # np.savez_compressed('/home/HPAI-BSC/Wind60.npz', **mdata)
