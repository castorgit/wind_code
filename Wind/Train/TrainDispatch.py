...
from Wind.Architectures import CNNS2SArchitecture, CNNS2SCrazyIvanArchitecture, CNNS2SCrazyIvan2HArchitecture, CNNS2SCrazyIvan3HArchitecture, CNNS2S2DArchitecture,  \
    ...
    CNNMIMOResidualArchitecture, CNNS2SCrazyIvan4HArchitecture
...
class TrainDispatch:
    ...
    def __init__(self):
        ...
        self.model_dict['CNN_CI_4H_s2s'] =(train_sequence2sequence, CNNS2SCrazyIvan4HArchitecture)

        self.model_dict['CNN_s2s_gb'] = (train_gradient_boosting_sequence2sequence, CNNS2SArchitecture)
        self.model_dict['CNN_sep_2l_s2s_gb'] = (train_gradient_boosting_sequence2sequence, CNNSeparable2LS2SArchitecture)
