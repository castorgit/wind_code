...
if __name__ == '__main__':
    ...
    a = (dataset.compute_measures(var=0,window={'12h':12, '24h':24}))
    saveconfig(config,a, mino=True)
 #   print(dataset.compute_measures(var=0,window={'12h':12, '24h':24, '1w':168, '1m':720, '3m':2190, '6m':4380}))
