...
from keras.layers import Dense, Dropout, Conv1D, Flatten, Input, Concatenate,MaxPooling1D,AveragePooling1D
...
class CNNS2SSkipArchitecture(NNS2SArchitecture):
    ...
    def generate_model(self):
        ...
        input_pooled = AveragePooling1D(pool_size=(2), strides=None, padding='same')(input)
