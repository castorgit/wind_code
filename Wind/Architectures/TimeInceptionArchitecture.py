...
class TimeInceptionArchitecture(NNS2SArchitecture):
    ...
    def inception_module(self, input_tensor, filters, kernel_size, activation, bottleneck, bottleneck_size,padding,
        ...
        print('->', filters, kernel_size, activation, bottleneck, bottleneck_size,padding, drop, bnorm, bias, separable, depth_mul, stride)
    ...
    def shortcut_layer(self, input_tensor, out_tensor, padding, activation, bnorm, bias):
