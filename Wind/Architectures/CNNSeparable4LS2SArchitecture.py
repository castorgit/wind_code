...
class CNNSeparable4LS2SArchitecture(NNS2SArchitecture):
    """
    ...
    def generate_model(self):
        ...
        model = SeparableConv1D(filters4[0], kernel_size=kernel_size4[0], strides=strides4[0],
                          padding='same', dilation_rate=dilation4[0],depth_multiplier=depth_multiplier4,
                          kernel_regularizer=k_regularizer)(model)
        model = generate_activation(activation)(model)
