...
:Description: CNNS2SArchitecture
    ...
    Class for convolutional sequence to sequence architecture with exactly 2 layers
...
class CNN2LS2SArchitecture(NNS2SArchitecture):
    """
