...
REM Genetic
python GenerateExpConfPseudoSMAC.py --config config_crazyivan_JM.json --pconfig pconfig_crazyivan_JM.json --exp smacIVANjm1 --exploit genetic --npar 20 --nbatches 4 --confexp 600 --nbest 10 --cross 0.8 --mutate 0.8
