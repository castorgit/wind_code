...
* For creating a new experiment search with config_*** and pconfig_*** configuration files generating batches
for --init sites
...
current configurations. The configurations are pick after a maximum of --confexp configurations are generated

 python3 GenerateExpConfPseudoSMAC.py --config config_***.json --pconfig pconfig_***.json  --exp experiment
 --exploit local --npar 99 --print --nbatches 9 --confexp 9999 --nbest 99

* for exploiting the prediction surface generating a maximum of --npar configurations based on crossover and
 mutation from the --nbest best current configurations. The configurations are pick after a maximum of --confexp
 configurations are generated by mutating pairs of configurations with  --cross [0-1] crossover probability and
...
def generate_random_configurations(conf_done, configP, maxtries, maxconf, nbatches):
    """
...
if __name__ == '__main__':
    ...
    # the value given by init it is divided in batches of 25
    BATCH = 25
    ...
    # Experiment already initialized
        ...
        # 2) Generate more experiments for the configurations with higher score
            ...
            intensify_configurations(args.exp, args.npar, args.nbatches)
